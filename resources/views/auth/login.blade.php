<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="email" class="text-white" :value="__('Почта')"/>
            <x-text-input
                id="email"
                class="form-control"
                type="email"
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" class="text-white" :value="__('Пароль')"/>
            ...
            <label for="remember_me" class="inline-flex items-center">
                <input
                    ...
                    class="rounded dark:bg-gray-900 border-gray-300
                            dark:border-gray-700 text-indigo-600 shadow-sm
